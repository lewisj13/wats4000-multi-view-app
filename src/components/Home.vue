<template>
  <div class="home">
    <div v-show="showForm" class="form-container">
      ...
      <p v-show="showError" class="error"> There is an error within the form. Please check you information in each field. </p>
      ...
      <form v-on:submit.prevent="validateForm">
        ...
        <p><label for="passwordVerify">
          <input type="password" id="passwordVerify" v-model="passwordVerify" placeholder="Enter the Password again">
        </label> </p>
